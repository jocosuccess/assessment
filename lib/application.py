...
from lib.powlib import merge_two_dicts
from database.sqldblib import Base, Session, engine
from conf.config import myapp
from conf.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'assessment.handlers.' + m)    
            try:
                mod = importlib.import_module('assessment.handlers.' + m)
            except:
                pass
            #print(dir(mod))
