...
server_settings = {
    ...
    "cookie_secret"     :   "2c373a5d-dd60-45d0-8aaa-f5c14ee2dfac",
    "ssl"               :   False,
    "ssl_options"       :   {
...
myapp = {
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   lib.encoders.json_to_json(),
            "csv"   :   lib.encoders.json_to_csv(),
            "xml"   :   lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
...
database = {
    ...
    "sql"   : {
        ...
        "dbname"    :   os.path.join(DATADIR, 'database.db'),   # just a name for non file based DBs
        "host"      :   None,     
        "port"      :   None,     
        "user"      :   None,     
        "passwd"    :   None,
