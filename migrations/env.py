...
from assessment.lib.powlib import get_class_name
from assessment.conf.config import myapp
from assessment.lib.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('assessment.models.sql.' + m)
...
#from assessment.dblib import Base
