...
def test_sql_generate_model(modelname):
    ...
    import uuid
    import os.path
    ret = gm.generate_model(modelname, "sql", appname="assessment")
...
def test_sql_model_type():
    ...
    from models.sql.pow_test_model import PowTestModel
    m = PowTestModel()
...
def test_sql_dbsetup():
    ...
    import init_sqldb_environment
    import os
    os.chdir("..")
    r = init_sqldb_environment.init_migrations()
    assert r == True
...
def test_sql_migration():
    ...
    import os
    os.chdir("..")
    script = generate_migration.generate_migration(message="pow_test")
